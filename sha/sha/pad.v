                        ...
                        // --- B. Last Word (Data + Padding) ---
                         ...
                         `ifdef SHA512
                            case (msg_last_bytes)
                                ...
                                3'd1: buffer[word_ptr] <= {msg_data[64:56], 8'h80, 48'h0};
                                3'd2: buffer[word_ptr] <= {msg_data[64:48], 8'h80, 40'h0};
                                3'd3: buffer[word_ptr] <= {msg_data[64:40], 8'h80, 32'h0};
                                3'd4: buffer[word_ptr] <= {msg_data[64:32], 8'h80, 24'h0};
                                3'd5: buffer[word_ptr] <= {msg_data[64:24], 8'h80, 16'h0};
                                3'd6: buffer[word_ptr] <= {msg_data[64:16], 8'h80, 8'h0};                
                                3'd7: buffer[word_ptr] <= {msg_data[64:8], 8'h80};
                            endcase
