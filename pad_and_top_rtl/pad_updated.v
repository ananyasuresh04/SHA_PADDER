...
/*    always @(*) begin
   ...
   assign blk0_out  = schedule_ready ? buffer[0] : {SHA_WORD_WIDTH{1'b0}}; 
   assign blk1_out  = schedule_ready ? buffer[1] : {SHA_WORD_WIDTH{1'b0}}; 
   assign blk2_out  = schedule_ready ? buffer[2] : {SHA_WORD_WIDTH{1'b0}}; 
   assign blk3_out  = schedule_ready ? buffer[3] : {SHA_WORD_WIDTH{1'b0}}; 
   assign blk4_out  = schedule_ready ? buffer[4] : {SHA_WORD_WIDTH{1'b0}};     
   assign blk5_out  = schedule_ready ? buffer[5] : {SHA_WORD_WIDTH{1'b0}}; 
   assign blk6_out  = schedule_ready ? buffer[6] : {SHA_WORD_WIDTH{1'b0}}; 
   assign blk7_out  = schedule_ready ? buffer[7] : {SHA_WORD_WIDTH{1'b0}}; 
   assign blk8_out  = schedule_ready ? buffer[8] : {SHA_WORD_WIDTH{1'b0}}; 
   assign blk9_out  = schedule_ready ? buffer[9] : {SHA_WORD_WIDTH{1'b0}}; 
   assign blk10_out = schedule_ready ? buffer[10]: {SHA_WORD_WIDTH{1'b0}}; 
   assign blk11_out = schedule_ready ? buffer[11]: {SHA_WORD_WIDTH{1'b0}}; 
   assign blk12_out = schedule_ready ? buffer[12]: {SHA_WORD_WIDTH{1'b0}}; 
   assign blk13_out = schedule_ready ? buffer[13]: {SHA_WORD_WIDTH{1'b0}};     
   assign blk14_out = schedule_ready ? buffer[14]: {SHA_WORD_WIDTH{1'b0}};     
   assign blk15_out = schedule_ready ? buffer[15]: {SHA_WORD_WIDTH{1'b0}};  
